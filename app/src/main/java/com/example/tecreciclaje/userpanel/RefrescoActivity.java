...
public class RefrescoActivity extends AppCompatActivity {
    ...
    private static final int PUNTOS_NECESARIOS = 1200;
    ...
    private void getUserData(String uid) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(RefrescoActivity.this, "Error al obtener datos del usuario.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void realizarCanje(String uid, int puntosActuales) {
        ...
        if (valeId != null) {
            ...
            nuevoValeRef.child("producto").setValue("Refresco (600ml)");
            nuevoValeRef.child("estado").setValue("Válido");
            nuevoValeRef.child("imagen_url").setValue("https://firebasestorage.googleapis.com/v0/b/resiclaje-39011.firebasestorage.app/o/refresco.png?alt=media&token=58da3323-7cc7-4448-9389-e3b261eb15ef");
        ...
        if (historialId != null) {
            ...
            historialRef.child(historialId).child("producto").setValue("Refresco 600ml");
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Ver vale", (dialog, which) -> {
                    Intent intent = new Intent(RefrescoActivity.this, MisValesActivity.class);
