// ✅ CafeActivity.java (realiza el canje, guarda en vales y historial)
...
public class DesayunoActivity extends AppCompatActivity {
    ...
    private static final int PUNTOS_NECESARIOS = 500;
    ...
    private void getUserData(String uid) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(DesayunoActivity.this, "Error al obtener datos del usuario.", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        btnCanjear.setOnClickListener(v -> {
            if (puntos >= PUNTOS_NECESARIOS) {
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("¿Estás seguro de que deseas canjear 5000 puntos por un desayuno?")
                        .setPositiveButton("Sí", (dialog, which) -> {
    ...
    private void realizarCanje(String uid, int puntosActuales) {
        ...
        if (valeId != null) {
            ...
            nuevoValeRef.child("producto").setValue("Desatuno Completo");
            nuevoValeRef.child("estado").setValue("Válido");
            nuevoValeRef.child("imagen_url").setValue("https://firebasestorage.googleapis.com/v0/b/resiclaje-39011.firebasestorage.app/o/desayuno.png?alt=media&token=d6b5198e-2e9a-4a64-9e97-959ced96b104");
        ...
        if (historialId != null) {
            ...
            historialRef.child(historialId).child("producto").setValue("Desayuno");
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Ver vale", (dialog, which) -> {
                    Intent intent = new Intent(DesayunoActivity.this, MisValesActivity.class);
