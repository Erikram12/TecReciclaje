...
class DesayunoActivity : AppCompatActivity() {
    ...
    companion object {
        private const val PUNTOS_NECESARIOS = 300
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        TutorialManager.showProductoTutorialIfNeeded(this, "Desayuno", R.drawable.desayuno)
    }
    ...
    private fun setupHelpButton() {
        btnAyuda.setOnClickListener {
            ...
            TutorialManager.showProductoTutorial(this, "Desayuno", R.drawable.desayuno)
        }
    }
    ...
    private fun getUserData(uid: String) {
        ...
        userRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Log.e("DesayunoActivity", "Error al obtener datos del usuario", error.toException())
            }
        })
    }
        ...
        btnCanjear.setOnClickListener {
            if (puntos >= PUNTOS_NECESARIOS) {
                AlertDialog.Builder(this)
                    ...
                    .setMessage("¿Estás seguro de que deseas canjear $PUNTOS_NECESARIOS puntos por un Desayuno?")
    ...
    private fun realizarCanje(uid: String, puntosActuales: Int) {
        ...
        if (valeId != null) {
            ...
            nuevoValeRef.child("vale_producto").setValue("Desayuno")
            nuevoValeRef.child("vale_estado").setValue("Válido")
            nuevoValeRef.child("vale_imagen_url").setValue("https://firebasestorage.googleapis.com/v0/b/resiclaje-39011.firebasestorage.app/o/desayuno.png?alt=media&token=example")
        ...
        if (historialId != null) {
            ...
            historialRef.child(historialId).child("historial_producto").setValue("Desayuno")
