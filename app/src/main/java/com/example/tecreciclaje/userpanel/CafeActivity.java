...
public class CafeActivity extends AppCompatActivity {
    ...
    private static final int PUNTOS_NECESARIOS = 200;
    ...
    private void getUserData(String uid) {
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(CafeActivity.this, "Error al obtener datos del usuario.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void realizarCanje(String uid, int puntosActuales) {
        ...
        if (valeId != null) {
            ...
            nuevoValeRef.child("producto").setValue("Taza de Café");
            nuevoValeRef.child("estado").setValue("Válido");
            nuevoValeRef.child("imagen_url").setValue("https://firebasestorage.googleapis.com/v0/b/resiclaje-39011.firebasestorage.app/o/cafesito1.png?alt=media&token=5a9467fa-32c0-4fb4-a221-900be22afb73");
        ...
        if (historialId != null) {
            ...
            historialRef.child(historialId).child("producto").setValue("Taza de Café");
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Ver vale", (dialog, which) -> {
                    Intent intent = new Intent(CafeActivity.this, MisValesActivity.class);
