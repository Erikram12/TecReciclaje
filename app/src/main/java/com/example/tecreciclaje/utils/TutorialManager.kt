...
object TutorialManager {
    ...
    /**
     * Muestra el tutorial de Producto si es necesario (con recurso de imagen)
     */
    ...
    /**
     * Muestra el tutorial de Producto (con recurso de imagen)
     */
    ...
    /**
     * Muestra el tutorial de Producto si es necesario (con URL de imagen)
     */
    fun showProductoTutorialIfNeededConUrl(context: Context, productName: String, imageUrl: String) {
        val currentUser = FirebaseAuth.getInstance().currentUser
        if (currentUser == null) return
        ...
        showProductoTutorialConUrl(context, productName, imageUrl)
    }

    /**
     * Muestra el tutorial de Producto (con URL de imagen)
     */
    fun showProductoTutorialConUrl(context: Context, productName: String, imageUrl: String) {
        val dialog = Dialog(context).apply {
            requestWindowFeature(Window.FEATURE_NO_TITLE)
            setCancelable(false)
            setContentView(R.layout.dialog_tutorial_producto)
        ...
        if (imageUrl.isNotEmpty()) {
            ...
            iconoProducto?.setImageResource(R.drawable.placeholder_producto)
        }
